    ...
    return (
        ...
        <Box display={"flex"} w={"90%"} margin="auto">
            ...
            <AccordionItem>
                ...
                <Stack >
                    <Radio size="sm" value='bedroom'><Text textAlign={"left"} fontSize="11px">Novel</Text></Radio>
                    <Radio size="sm" value='living'><Text textAlign={"left"} fontSize="11px">Story Book</Text></Radio>
...
const Linkage=({A2,A3})=>{
    ...
    <BreadcrumbItem>
      <BreadcrumbLink fontSize={"xs"} href='/Packages'>{A2}</BreadcrumbLink>
    </BreadcrumbItem>
